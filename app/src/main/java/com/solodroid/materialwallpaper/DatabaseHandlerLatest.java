...
private static final int DATABASE_VERSION = 1;
	...
	private static final String DATABASE_NAME = "Latest";
	...
	public	void AddtoFavoriteLatest(Item_RecentWallpaper pj)
	{
	...
	// Getting All Data
		public List<Item_RecentWallpaper> getAllData() 
		{
			List<Item_RecentWallpaper> dataList = new ArrayList<Item_RecentWallpaper>();
			// Select All Query
			...
			{
				do {
					Item_RecentWallpaper contact = new Item_RecentWallpaper();
	...
	//getting single row
		...
		public List<Item_RecentWallpaper> getFavRow(String id) 
		{
			List<Item_RecentWallpaper> dataList = new ArrayList<Item_RecentWallpaper>();
			// Select All Query
	...
	//for remove favorite
		...
		public void RemoveFav(Item_RecentWallpaper contact)
		{
		    SQLiteDatabase db = this.getWritableDatabase();
